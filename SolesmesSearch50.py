...
text = "/home/alens/projects/Art/just_musicxml.txt"
directory01 = Path("/home/alens/projects/Art/musescoreStudioAlleluia")
...
# Select characters up to but not including 4
        ...
        dataframe01 = pandas.DataFrame(columns=['Page'])
        dataframe02 = dataframe01.copy()
        new_row_label = 2
        dataframe02.loc[new_row_label] = {'Page': database_unique_item}
